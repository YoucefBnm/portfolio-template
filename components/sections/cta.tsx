    ...
    <section>
      <ScrollAnimation className="">
        <ScrollTranslateY className="h-dvh md:w-4/5 mx-auto py-8 px-6 grid grid-cols-12 grid-rows-1">
          ...
          <GridBento
            variant={"fourCells"}
            className="[&>*:first-child]:origin-[10%_0%] [&>*:first-child]:hidden [&>*:first-child]:md:block  [&>*:nth-child(2)]:col-span-3  [&>*:nth-child(2)]:md:col-span-2 col-start-1 row-start-1 pointer-events-none row-end-2 col-end-13"
          >
